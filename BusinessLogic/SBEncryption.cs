...
{
    public static class SBEncryption
    {
        private static readonly string PasswordKey = "SmartEcommerce";
        ...
        private static readonly string passwordPhrase = "SB81";
        ...
        public static string getMD5Password(string UserId, string Password)
        {
            ...
            string rsult = clsSBEncryption.MD5Hash(keys[0] + UserId + keys[1] + Password + keys[2]);
        ...
        private static string Decrypt(string cipherText, string passPhrase)
        {
            ...
            {
                Logs.WriteError("Decrpt", ae.Message);
                return "";
            }
    ...
    public static class clsSBEncryption
    {

...
;(function(window) {
  ...
  jQuery(document).ready(function ($) {
      var alterClass = function () {
          var ww = document.body.clientWidth;
          if (ww > 767) {
              $('.relatedVideoArea .productBox').addClass('BoxGrid3');
          } else {
              $('.relatedVideoArea .productBox').removeClass('BoxGrid3');
          };
          if (ww < 767) {
              $('.relatedVideoArea .productBox').addClass('BoxGrid2');
          } else {
              $('.relatedVideoArea .productBox').removeClass('BoxGrid2');
          };
          if (ww > 320) {
              $('.relatedVideoArea .productBox').addClass('BoxGrid2');
          } else {
  ...
  jQuery(document).ready(function ($) {
      if ($(window).width() < 991) {
          $('.relatedVideoArea').removeClass('list');
      } else {
          $('.relatedVideoArea').addClass('list');
      }
  });
  jQuery(document).ready(function ($) {
      if ($(window).width() > 991) {
